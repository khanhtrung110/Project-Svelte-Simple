...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$8, 21, 4, 416);
    			attr_dev(header, "class", "svelte-xv0494");
    			add_location(header, file$8, 20, 0, 402);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$7, 88, 2, 1565);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$7, 86, 2, 1531);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			if (default_slot) default_slot.c();
    			attr_dev(span, "class", "svelte-1ucdme6");
    			add_location(span, file$6, 14, 2, 304);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(99:4) <Button type=\\\"button\\\">",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 61, 4, 1189);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 64, 4, 1355);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 57, 0, 942);
    			attr_dev(h1, "class", "svelte-pgewbm");
    			add_location(h1, file$2, 59, 4, 1024);
    			attr_dev(div1, "class", "content svelte-pgewbm");
    			add_location(div1, file$2, 60, 4, 1046);
    			attr_dev(footer, "class", "svelte-pgewbm");
    			add_location(footer, file$2, 63, 4, 1103);
    			attr_dev(div2, "class", "modal svelte-pgewbm");
    			add_location(div2, file$2, 58, 0, 999);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 53, 2, 1230);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 98, 2, 2661);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
